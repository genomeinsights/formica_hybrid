...
N  <- readRDS("moduleD_among_region_association/data/moduleD_network.rds"); mn <- as.data.table(N$meta_nodes); me <- as.data.table(N$meta_edges)
...
png("moduleD_among_region_association/Figures/moduleD_trans_network.png", width = 1900, height = 1500, res = 200)
...
draw_circos(me, "moduleD_among_region_association/Figures/moduleD_trans_circos.png",
  "Module D meta-network: all association bands, opacity ~ degree (grey = structure, gold = candidate)", hub_beds)
draw_circos(me[a_str == FALSE & b_str == FALSE], "moduleD_among_region_association/Figures/moduleD_candidate_circos.png",
...
draw_circos(me[a_str == TRUE & b_str == TRUE], "moduleD_among_region_association/Figures/moduleD_structure_circos.png",
...
draw_circos(wm, "moduleD_among_region_association/Figures/moduleD_module_circos.png",
