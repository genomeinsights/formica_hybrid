...
N <- readRDS("moduleD_among_region_association/data/moduleD_network.rds"); mn <- as.data.table(N$meta_nodes)
...
draw_module <- function(mod) {
  ...
  f <- sprintf("moduleD_among_region_association/Figures/moduleD_module_%02d_heatmap.png", mod)
