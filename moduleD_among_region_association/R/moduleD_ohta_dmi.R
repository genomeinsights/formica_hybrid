...
source("moduleD_among_region_association/R/Ohta.R")   # ohta_fast_prepare(), dstat_unphased_scan() (uses parallel::mclapply)
source("moduleD_among_region_association/R/moduleD_paralogy.R")   # cross-chromosome duplication filter (shared with the EMMAX arm)
set.seed(1)
...
saveRDS(list(pairs = pairs_dt, rst_hist = pf$hist, ranked = ranked,
        ...
        "moduleD_among_region_association/data/moduleD_ohta.rds")
...
ggsave("moduleD_among_region_association/Figures/moduleD_fig4.pdf", fig4, width = 210, height = 78, units = "mm")
ggsave("moduleD_among_region_association/Figures/moduleD_fig4.png", fig4, width = 210, height = 78, units = "mm", dpi = 300)
