...
Uses ./R/prune_snps_for_grm.R to prune markers for GRM construction.
...
Combines BayPass (step 3) and LD-decay (step 2) results to find outlier SNPs
that are stable across LD-weight and XtX significance thresholds.
...
## Shared functions
./R/Functions.R holds plotting/analysis helpers (Manhattan+DIEM overlay plots,
haplotype block detection) used across the pipeline scripts above.
