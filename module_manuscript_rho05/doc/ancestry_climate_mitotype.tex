...
\midrule
DI (Spearman $\rho$)            & PC1 & $+0.100$ & $+0.029$ & $[-0.018, 0.072]$ & $0.004$ \\
...
\emph{opposite} directions ($+0.100$ on PC1, above the null range; $-0.131$ on PC2, below
...
covariate would produce by chance ($\rho=-0.099$, below the null), while PC2 is
indistinguishable from the null ($p_{\mathrm{BH}}=0.269$). Directional sorting is where the
...
predicts ($0.036$ and $0.019$ vs.\ a null median of $0.123$) -- the \emph{opposite} of what a
...
sharpens rather than resolves the population-level picture above. The one climate result
that stands apart from this whole ancestry-confound narrative is bio\_winter (the combined,
standardized bio6/bio11 axis): 10 of 18{,}361 Stage-1 units survive the floor test
(FDR$\approx0.18$, Section~5), clearly stronger than PC1 or PC2 achieve on either scan and
not something this document's ancestry-confound argument accounts for -- an open lead for
future work, not explored further here. This document should be
