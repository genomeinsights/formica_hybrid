...
if(!file.exists("module0_ld_pruning/data/diem_parsed.rds")){
  ...
  saveRDS(list(GTs=GTs,map=map),"module0_ld_pruning/data/diem_parsed.rds")
...
if(!file.exists("data/hybrids_and_parents_maf005.Rdata")){
  # keep only hybrids
  ...
  load("data/hybrids_and_parents_maf005.Rdata")
}




if(!file.exists("module0_ld_pruning/data/ld_decay_DIEM_100w.rds")){
  ...
  saveRDS(ld_decay_DIEM_100w,"module0_ld_pruning/data/ld_decay_DIEM_100w.rds")
  ...
  #plot(ld_decay_DI,type="chr")
  saveRDS(ld_decay_DI,"module0_ld_pruning/data/ld_decay_DI.rds")
  
}else{
  ld_decay <- readRDS("module0_ld_pruning/data/ld_decay_DIEM_100w.rds")  
  #ld_decay_DI <- readRDS("module0_ld_pruning/data/ld_decay_DI.rds")  
}
...
saveRDS(map_hyb_005[, .(Chr, Pos, ld_w_095)], "module0_ld_pruning/data/ld_tracks_ldw_persnp.rds")
saveRDS(
...
ggsave("module0_ld_pruning/Figures/p_ldw_a_recmap_scatter.png", p_scatter, width = 20, height = 5)
...
ggsave("module0_ld_pruning/Figures/p_roc_low_recombination.png", p_roc, width = 13, height = 5)

saveRDS(
  list(comp_dt = comp_dt, cor_tbl = cor_tbl, roc_summary = roc_summary),
  "module0_ld_pruning/data/ldw_a_recmap_comparison.rds"
)
