...
## decay object:
##   module0_ld_pruning/data/ld_tracks_a_windows.rds   -- windowed decay rate a (Chr, mid, a, regime)
##   module0_ld_pruning/data/ld_tracks_ldw_persnp.rds  -- per-SNP ld_w (Chr, Pos, ld_w_095)
...
aw  <- readRDS("module0_ld_pruning/data/ld_tracks_a_windows.rds")[Chr %in% CHRS & regime == "structured" & is.finite(a)]
ldw <- readRDS("module0_ld_pruning/data/ld_tracks_ldw_persnp.rds")[Chr %in% CHRS & is.finite(ld_w_095)]
...
ggsave("module0_ld_pruning/Figures/ld_tracks_chr26_chr10.pdf", fig, width = 180, height = 110, units = "mm")
ggsave("module0_ld_pruning/Figures/ld_tracks_chr26_chr10.png", fig, width = 180, height = 110, units = "mm", dpi = 300)
cat("Saved: module0_ld_pruning/Figures/ld_tracks_chr26_chr10.pdf/.png\n")
