...
png("Figures/moduleD_emmax_writeup.png", width = 2100, height = 1350, res = 200)
...
O  <- readRDS("data/moduleD_ohta.rds")$pairs
...
ggsave("Figures/moduleD_paralogy_writeup.png", pa + pb, width = 210, height = 90, units = "mm", dpi = 200)
