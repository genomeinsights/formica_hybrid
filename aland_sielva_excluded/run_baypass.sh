#!/usr/bin/env bash
# BayPass runs for the Aland-AND-Sielva-excluded comparison analysis --
# both Aland (climatic/genetic outlier) and Sielva (very young population,
# unusually high heterozygosity genome-wide) excluded together.
#
...
echo "=== 1. Estimating Omega (pruned data, Aland and Sielva excluded) ==="
"${PATH_TO_BAYPASS}" \
